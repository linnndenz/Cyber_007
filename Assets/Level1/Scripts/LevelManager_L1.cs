...
public sealed class LevelManager_L1 : LevelManager
{
    ...
    public override void InitItems()
    {
        ...
        item_dict.Add("床下的罐子",new Item("床下的罐子", true,Resources.Load<Sprite>("Texture_L1/床下的罐子"),null,null));
        ...
        item_dict.Add("锤子",new Item("锤子", true,Resources.Load<Sprite>("Texture_L1/锤子"),null,null));
